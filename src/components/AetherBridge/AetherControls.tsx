      ...
      <div className="grid grid-cols-1 gap-2.5 font-sans">
        ...
        <button
          ...
          className={`p-3.5 rounded-xl border font-bold text-xs flex items-center justify-center space-x-2.5 transition-all shadow-xs cursor-pointer ${data.pttActive
              ? 'bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-white border-red-700 ring-2 ring-red-400/40 animate-pulse shadow-[0_0_20px_rgba(239,68,68,0.5)]'
              : 'bg-gradient-to-r from-teal-600 to-cyan-700 hover:from-teal-700 hover:to-cyan-800 text-white border-teal-700 shadow-2xs dark:shadow-[0_0_15px_rgba(20,184,166,0.3)]'
            }`}
        >
        ...
        <button
          ...
          className={`p-3.5 rounded-xl border font-semibold text-xs flex items-center justify-center space-x-2.5 transition-all shadow-xs cursor-pointer ${data.noiseInjected
              ? 'bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white border-amber-600 shadow-[0_0_15px_rgba(245,158,11,0.35)]'
              : 'bg-white dark:bg-slate-950/70 hover:bg-slate-100 dark:hover:bg-slate-800/80 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-800 shadow-2xs'
            }`}
        >
        ...
        <button
          ...
          className="p-3.5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/70 hover:bg-amber-50/80 dark:hover:bg-amber-950/30 hover:border-amber-300 dark:hover:border-amber-700/60 text-slate-700 dark:text-slate-200 hover:text-amber-900 dark:hover:text-amber-300 font-semibold text-xs flex items-center justify-center space-x-2.5 transition-all shadow-2xs cursor-pointer"
        >
        ...
        <button
          ...
          className="p-3.5 rounded-xl border border-teal-200 dark:border-teal-500/40 bg-teal-50/80 dark:bg-teal-950/40 hover:bg-teal-100/90 dark:hover:bg-teal-900/50 text-teal-950 dark:text-teal-200 font-bold text-xs flex items-center justify-center space-x-2.5 transition-all shadow-2xs cursor-pointer dark:shadow-[0_0_12px_rgba(20,184,166,0.15)]"
        >
