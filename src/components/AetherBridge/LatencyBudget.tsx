    ...
    <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xs p-3.5 rounded-2xl border border-slate-200/90 dark:border-slate-800 shadow-xs flex flex-col gap-2.5 font-sans transition-colors duration-200">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-1.5">
          <div className="p-1 rounded-lg bg-teal-50 dark:bg-teal-950/50 text-teal-700 dark:text-teal-400 border border-teal-200 dark:border-teal-800/60">
        ...
        <span className="text-[10px] font-semibold text-teal-800 dark:text-teal-300 bg-teal-50 dark:bg-teal-950/40 border border-teal-200/80 dark:border-teal-800/60 px-2 py-0.5 rounded-full">
          ITU-T &lt; 150ms
        </span>
      </div>
      ...
      <div className="grid grid-cols-3 gap-1.5 text-center">
        <div className="bg-gradient-to-br from-teal-50/70 to-slate-50 dark:from-teal-950/40 dark:to-slate-800/60 p-2 rounded-xl border border-teal-200/70 dark:border-teal-800/60 shadow-2xs">
        ...
        <div className="bg-slate-50/80 dark:bg-slate-800/60 p-2 rounded-xl border border-slate-200/80 dark:border-slate-700/60 shadow-2xs">
        ...
        <div className="bg-gradient-to-br from-emerald-50/70 to-slate-50 dark:from-emerald-950/40 dark:to-slate-800/60 p-2 rounded-xl border border-emerald-200/70 dark:border-emerald-800/60 shadow-2xs">
      ...
      <div className="space-y-1.5 bg-slate-50/60 dark:bg-slate-800/60 p-2.5 rounded-xl border border-slate-200/70 dark:border-slate-700/60">
        ...
        <div className="w-full h-3 bg-slate-200/80 dark:bg-slate-700 rounded-full overflow-hidden border border-slate-300/80 dark:border-slate-600 flex p-0.5">
          {items.map((item, i) => {
      ...
      <div className="grid grid-cols-2 gap-1.5 text-xs">
        {items.map((item, i) => (
          <div key={i} className="flex items-center justify-between bg-slate-50/80 dark:bg-slate-800/80 px-2 py-1.5 rounded-xl border border-slate-200/80 dark:border-slate-700/70">
